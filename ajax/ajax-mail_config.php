...
if (isset($_POST[$id_form])) {
    ...
    if (defined('id_form')) { // detiene el código en caso de que ingrese información de dos o mas form diferentes
        ...
        define('reg_apellido1', $_POST[$id_form]['ApellidoPaterno']); // cambiar el identificador del nombre de la persona que envía en caso de no contar con este campo marcarlo como ''
        define('reg_apellido2', $_POST[$id_form]['ApellidoMaterno']);
        define('reg_sucursal', $_POST[$id_form]['sucursal']);  // cambiar el identificador del nombre de la persona que envía en caso de no contar con este campo marcarlo como ''
        define('reg_puesto', $_POST[$id_form]['puesto']);  // cambiar el identificador del nombre de la persona que envía en caso de no contar con este campo marcarlo como ''
        define('reg_telefono', $_POST[$id_form]['telefono']);
