...
function cltvo_js(){
	wp_register_script( 'cltvo_functions_js', JSPATH.'functions.js', array('jquery', 'scrollIt','validate','swiper','googlemaps'), false, true );
	...
	wp_register_script( 'googlemaps', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyAzVu9K3xbC3C_nntBjW1EIGTFhTubL3Og&callback=initMap', array(), null, true );
